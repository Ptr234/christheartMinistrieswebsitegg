      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <div style={{ display: "flex", gap: "0.5rem", alignItems: "center", flexWrap: "wrap" }}>
              ...
              >
                <Youtube size={14} style={{ marginRight: 6 }} /> Christ's Heart TV
              </a>
              ...
              <a
                ...
                className="media-btn"
                style={{ backgroundColor: "#fff", color: "#000", border: "1px solid #000", padding: "0.45rem 0.75rem", borderRadius: 6, cursor: "pointer", textDecoration: "none", display: "inline-flex", alignItems: "center" }}
              >
                <Radio size={14} style={{ marginRight: 6 }} /> Christ's Heart Radio
              </a>
            </div>
        ...
        <div className="footer-bottom">
          ...
          <div className="footer-bottom-links">
            <a href="https://www.instagram.com/promisetvug/?hl=en" target="_blank" rel="noopener noreferrer" aria-label="PROMISE TV bottom" className="media-btn" style={{ backgroundColor: "#FFD700", color: "#000", border: "none", padding: "0.35rem 0.6rem", borderRadius: 6, cursor: "pointer", marginRight: 8, textDecoration: "none" }}>PROMISE TV</a>
            <a href="https://www.youtube.com/@ChristsHeart" target="_blank" rel="noopener noreferrer" aria-label="Christ's Heart TV bottom" className="media-btn" style={{ backgroundColor: "#7c3aed", color: "#fff", border: "none", padding: "0.35rem 0.6rem", borderRadius: 6, cursor: "pointer", marginRight: 8, textDecoration: "none" }}>Christ's Heart TV</a>
            <a href="https://christsheart.org/radio/" target="_blank" rel="noopener noreferrer" aria-label="Christ's Heart Radio bottom" className="media-btn" style={{ backgroundColor: "#fff", color: "#000", border: "1px solid #000", padding: "0.35rem 0.6rem", borderRadius: 6, cursor: "pointer", textDecoration: "none" }}>Christ's Heart Radio</a>
          </div>
        </div>
      </div>
    </footer>
