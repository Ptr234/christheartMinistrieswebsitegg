      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <div style={{ display: "flex", gap: "0.5rem", alignItems: "center", flexWrap: "wrap" }}>
              ...
              <a
                href="https://www.tiktok.com/@christsheartmin"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="TikTok"
                className="media-btn"
                style={{ backgroundColor: "#010101", color: "#fff", border: "1px solid rgba(255,255,255,0.15)", padding: "0.45rem 0.75rem", borderRadius: 6, cursor: "pointer", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: "6px" }}
              >
        ...
        <div className="footer-bottom">
          ...
          <div className="footer-bottom-links">
            <a href="https://www.youtube.com/@ChristsHeart" target="_blank" rel="noopener noreferrer" aria-label="ChristHeartTV" className="media-btn" style={{ backgroundColor: "#7c3aed", color: "#fff", border: "none", padding: "0.35rem 0.6rem", borderRadius: 6, cursor: "pointer", marginRight: 8, textDecoration: "none" }}>ChristHeartTV</a>
            <a href="https://christsheart.org/radio/" target="_blank" rel="noopener noreferrer" aria-label="Christ's Heart Radio" className="media-btn" style={{ backgroundColor: "#fff", color: "#000", border: "1px solid #e5e7eb", padding: "0.35rem 0.6rem", borderRadius: 6, cursor: "pointer", marginRight: 8, textDecoration: "none" }}>ChristHeart Radio</a>
            <a href="https://www.instagram.com/promisetvug/?hl=en" target="_blank" rel="noopener noreferrer" aria-label="PROMISE TV" className="media-btn" style={{ backgroundColor: "#FFD700", color: "#000", border: "none", padding: "0.35rem 0.6rem", borderRadius: 6, cursor: "pointer", marginRight: 8, textDecoration: "none" }}>Promise TV</a>
            <a href="https://www.tiktok.com/@christsheartmin" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="media-btn" style={{ backgroundColor: "#010101", color: "#fff", border: "none", padding: "0.35rem 0.6rem", borderRadius: 6, cursor: "pointer", textDecoration: "none" }}>TikTok</a>
          </div>
        </div>
      </div>
    </footer>
