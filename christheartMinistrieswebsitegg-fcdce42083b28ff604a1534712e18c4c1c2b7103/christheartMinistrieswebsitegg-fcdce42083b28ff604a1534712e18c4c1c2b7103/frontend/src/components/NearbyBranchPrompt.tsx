  ...
  return (
    <>
      ...
      <div className={`nearby-prompt ${visible ? "nearby-prompt-visible" : ""}`}>
        ...
        {/* Step 2d: Select with error */}
        {step === "select" && locationError && (
          <div style={{ padding: "0.75rem 1.25rem", margin: "0 1.25rem 0.5rem", background: "var(--gold-300)", borderRadius: "var(--radius-md)", fontSize: "0.85rem", color: "var(--gray-800)" }}>
            {locationError}
          </div>
        )}
