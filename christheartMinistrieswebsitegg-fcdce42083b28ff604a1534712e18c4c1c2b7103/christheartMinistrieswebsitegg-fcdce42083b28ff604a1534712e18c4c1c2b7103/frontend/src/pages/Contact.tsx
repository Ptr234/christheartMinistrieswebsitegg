    ...
    <>
      ...
      <div className="wave-divider">
        <svg viewBox="0 0 1440 60" preserveAspectRatio="none">
          <path d="M0,0 C360,60 1080,0 1440,60 L1440,0 L0,0 Z" fill="#1f0530" />
        </svg>
      </div>
      ...
      <section className="section">
        <div className="container" style={{ maxWidth: "1100px" }}>
          <div className="animate-on-scroll" ref={formRef}>
            <div className="contact-split">
              ...
              <div className="contact-split-info">
                ...
                <p style={{ opacity: 1, color: "rgba(255,255,255,0.9)", marginBottom: "2rem", lineHeight: 1.7 }}>
          ...
          {/* Interactive Map */}
          <div style={{ marginTop: "3rem", borderRadius: "var(--radius-2xl)", overflow: "hidden" }}>
            <Suspense fallback={<div style={{ height: "300px", display: "flex", alignItems: "center", justifyContent: "center", background: "var(--purple-50)", borderRadius: "var(--radius-2xl)", color: "var(--text-light)" }}>Loading map...</div>}>
              <LocationMap
