            ...
            <div className="feature-row">
              ...
              <div className="feature-row-text">
                ...
                <p>
                  ...
                  impact is felt through a spectrum of services, dynamic discipleship, engaging fellowships,
          ...
          <div className="animate-on-scroll" ref={ourStoryRef}>
            <div className="feature-row reverse">
              ...
              <div className="feature-row-text">
                ...
                <p>
                  What began as a humble gathering in Mukono has transformed into a vibrant, growing
                  ministry with branches across Uganda and around the world. The impact of Christ's Heart
                  Ministries is felt through a spectrum of services, discipleship, engaging fellowships,
                  and impactful outreach programs.
                </p>
                <p>
                  Founded in 2007, CHMI stands as a beacon of transformative spirituality — raising men
                  and women who walk in divine authority, power, and purpose, impacting nations through
                  the tangible manifestation of God's power.
                </p>
                <div style={{ display: "flex", flexWrap: "wrap", gap: "0.75rem", marginTop: "1.5rem" }}>
                  {[
                    ...
                    <div key={v.label} style={{
                      ...
                      padding: "0.5rem 1rem", background: "var(--purple-50)",
      ...
      <section className="section" style={{ background: "var(--bg-alt)" }}>
        <div className="container">
          <div ref={purposeRef} className="animate-on-scroll" style={{ maxWidth: "900px", margin: "0 auto", textAlign: "center" }}>
            ...
            <h2 className="gradient-text" style={{ marginBottom: "2.5rem" }}>Vision &amp; Mission</h2>
