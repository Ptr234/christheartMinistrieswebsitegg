...
import { MapPin, Phone, Mail, Clock, ArrowLeft, User, Quote, Church, Users } from "lucide-react";
              ...
              <div className="branch-info-card" style={{ marginBottom: "1.5rem" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                    ...
                    <span style={{ fontSize: "0.9rem", color: "var(--gray-600)" }}>{branch.address}</span>
                  </div>
                  <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                    <div style={{
                      width: "36px", height: "36px", borderRadius: "var(--radius-lg)",
              ...
              <div className="branch-info-card">
                ...
                <div className="map-placeholder">
                  <div style={{ textAlign: "center" }}>
                    ...
                    <p style={{ fontSize: "0.75rem", opacity: 0.6, marginTop: "0.25rem", fontFamily: "var(--font-mono)" }}>
