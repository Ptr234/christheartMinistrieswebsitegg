...
import { Calendar, Clock, MapPin, ArrowLeft, CheckCircle, Users, ArrowRight, Sparkles } from "lucide-react";
        ...
        <div className="container" style={{ maxWidth: "900px" }}>
          <div className="animate-on-scroll" ref={contentRef}>
            ...
            <div style={{
              ...
              <img
                src={eventImages[eventIndex >= 0 ? eventIndex % eventImages.length : 0]}
                alt={event.name}
                ...
                <div className="form-row" style={{ marginBottom: "1rem" }}>
                  ...
                  <div className="form-group">
                    ...
                    <select id="reg-branch" required>
                      ...
                      <option value="kampala">Christ's Heart Kampala</option>
                      <option value="mukono">Christ's Heart Mukono</option>
